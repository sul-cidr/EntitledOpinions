<div id="wrap">
    ...
    <div id="header" class="clearfix header" role="banner" <?php if ($header_bkg): ?>style="background-image: url('
        <?php print file_create_url(theme_get_setting( 'header_bkg_path')); ?>');"
        <?php endif; ?>>
        <div class="container">
            <div class="row">
